...
function App() {
  ...
  return (
    ...
    {/* AI语义 */}
      ...
      <div className="relative">
        ...
        <span className="absolute top-2 left-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded">
          new
           ...
           {/* 矢量图，数字形状来画图，支持无限的放大，不会模糊，区别于像素图 */}
      ...
      <div className="p-4">
        <h3 className="text-lg font-semibold text-grey-800 line-clamp-2">
        ...
        <span className="ml-1 text-xs text-gray-500">4.5(128 reviews)</span>
